...
Page({
  ...
  getBankList: function () {
    var _this = this;
    wx.request({
      url: cfg.requestURL + '/backend/seller/mobile/projectdetail?token=' + wx.getStorageSync('token') + '&projectId=' + _this.data.projectId, //仅为示例，并非真实的接口地址
      data: {},
      method: 'GET',
      header: {
